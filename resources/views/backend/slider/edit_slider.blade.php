    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <h4 class="header-title mb-4">Cập nhập slider</h4>

                <div class="row">
                    <div class="col-xl-12">
                        <form id="form_category_create" action="{{ URL::to('/admin/slider/update-slider/'.$slider->slider_id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value = "{{ $slider->slider_name }}" name="slider_name" class="form-control" id="">
                                    </div>
                                    @error('slider_name')
                                ...
                                <div class="col-md-4" id="add-image-file">
                                    <div class="mb-3">
                                        ...
                                        <div class="custom-file">
                                         ...
                                         <img width = "70px" src="{{ asset ('Backend/uploads/slider/'.$slider->slider_image) }}"> 
                                        @error('slider_image')
                                            <span class="erorr text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="slider_desc" class="form-control" id="ckeditor_desc" cols="0"
                                            rows="0">value = "{{ $slider->slider_desc }}"</textarea>
                                    </div>
                                    @error('slider_desc')
                                        <span class="erorr text-danger"> {{ $message }} </span>
                                    @enderror
