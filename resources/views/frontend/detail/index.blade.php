          ...
          <div class="gallerys pl-3 pr-3">
            ...
            <div class="gallery__nav d-flex mb-3 pb-3">
              <div class="image__item js-active-view active"
                   data-src="{{ asset ('Frontend/images/product/laptop2.webp') }}" data-toggle="modal">
                <img src="{{ asset ('Frontend/images/product/laptop2.webp') }}" alt="">
              </div>
              <div class="image__item js-active-view" data-src="{{ asset ('Frontend/images/product/laptop3.webp') }}"
                   data-toggle="modal">
                <img src="{{ asset ('Frontend/images/product/laptop3.webp') }}" alt="">
              </div>
              <div class="image__item js-active-view " data-src="{{ asset ('Frontend/images/product/laptop4.webp') }}"
                   data-toggle="modal">
                <img src="{{ asset ('Frontend/images/product/laptop4.webp') }}" alt="">
              </div>
              <div class="image__item js-active-view " data-src="{{ asset ('Frontend/images/product/laptop5.webp') }}"
                   data-toggle="modal">
                <img src="{{ asset ('Frontend/images/product/laptop5.webp') }}" alt="">
              </div>
              <div class="image__item js-active-view " data-src="{{ asset ('Frontend/images/product/laptop1.webp') }}"
                   data-toggle="modal">
            ...
            <div class="short__desc p-2 mb-3">
              {!! $value->product_desc !!}
              {{-- <span>- Màn hình: 14" ( 1920 x 1080 ) , không cảm ứng</span>
                <span>- RAM: 1 x 4GB DDR4 2400MHz</span>
                <span>- Đồ họa: Intel HD Graphics 620</span>
                <span>- Lưu trữ: 1TB HDD 5400RPM</span>
                <span>- Hệ điều hành: Free DOS</span>
                <span>- Pin: 3 cell 41 Wh Pin liền , khối lượng: 1.6 kg</span> --}}
            </div>
          </div>
        </div>
        <!-- end col5 -->
