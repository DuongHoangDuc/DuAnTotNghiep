    ...
    <div class="row ">
        ...
        <div class="bg-white rounded">
          <div class="row ">
            ...
            <div class="col-md-4">
              ...
              <p class="read-more read__specifications js-show-modal-specifications" data-toggle="modal">Đọc thêm <i class="fas fa-caret-down"></i></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="same__brand rounded">
          <div class="title">
            <h3 class="text--title m-0 ml-3">Cùng thương hiệu HP</h3>
